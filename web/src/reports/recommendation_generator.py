...
class ProblemEnum(Enum):
    ...
    GLOBAL_DUPLICATION_PROBLEM = "@1 instances of code duplication has been detected in this commit. Details in 'Duplication' section."
    GLOBAL_BUG_PROBLEM = "For a total of @1 files, @2 files reported at least one bug."
...
class RecommendationEnum(Enum):
    ...
    GLOBAL_BUG_RECOMMENDATION = "Dedicate more ressources to bug fixing. Consider refactoring and improving tests coverage."
...
class RecommendationGenerator:
    ...
    def _global_bug(self, entities : dict[str, list[EntityReport]], total_file_nb : int) -> Pair[str, str]:
