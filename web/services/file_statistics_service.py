...
class FilePrioritisationStats(CustomJsonEncoderInterface):
    complexity: float
...
class FileStatisticsService: 
    ...
    # value: complexity (int)
    def get_function_complexities_for_one_file(self, file_id : str) -> dict[str, int]:
    ...
    def get_complexity_average_for_one_file(self, file_id : str) -> float:
        ...
        return sum / len(function_complexities)
        
    def count_identifiable_identities_for_one_file(self, file_id : str) -> int:
        identifiable_entities = self._facade.get_identifiable_entities_for_one_file(file_id)
        return len(identifiable_entities)
    ...
    def get_prioritisation_stats_for_one_file(self, file_id : str) -> FilePrioritisationStats:
        ...
        return FilePrioritisationStats(complexity_avg, identifiable_entities_count, duplication_stats.duplication_count, duplication_stats.lines_duplicated)
